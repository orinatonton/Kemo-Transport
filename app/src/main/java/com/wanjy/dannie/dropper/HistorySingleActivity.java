...
import com.wanjy.dannie.dropper.MPESA.GateWay;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    for (DataSnapshot child:dataSnapshot.getChildren()){
                        ...
                        if (child.getKey().equals("Express")){
...
//                            deliveryPrice = Double.valueOf(distance) * 0.5;
        ...
        mPay.setOnClickListener(new View.OnClickListener() {
            @Override
              public void onClick(View view) {
                startActivity(new Intent(HistorySingleActivity.this, GateWay.class));
    ...
    private void payPalPayment() {
        PayPalPayment payment = new PayPalPayment(new BigDecimal(deliveryPrice), "USD", "Express",
